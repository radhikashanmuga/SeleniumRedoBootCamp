...
public class S0634_CreateLegalEntity extends BaseClass
{
	...
	{	
			...
			Thread.sleep(3000);	
			driver.findElement(By.xpath("(//a[@role='button'])[16]")).click();
			...
			wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//a[@role='menuitem'])[1]")));
			WebElement cases=driver.findElement(By.xpath("//span[text()='New Legal Entity']")); 
			...
			WebElement web=driver.findElement(By.xpath("//span[@data-aura-class='forceActionsText']"));
